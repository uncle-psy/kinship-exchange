    ...
    <div className="relative min-h-screen">
      ...
      <section className="relative">
        <div className="mx-auto max-w-6xl px-6 pt-10">
          <div
            className="surface-card flex flex-col gap-4 rounded-xl p-5 md:flex-row md:items-center md:justify-between"
            id="launch"
          >
            <div className="flex items-start gap-4">
              <span
                className="mt-1 inline-block h-2.5 w-2.5 rounded-full bg-[color:var(--accent)]"
                aria-hidden
              />
              <div>
        ...
        <section className="mx-auto max-w-6xl px-6 pt-20">
          ...
          <p className="mt-3 max-w-2xl text-sm text-[color:var(--muted)]">
            Skip the low-intent email list and the pay-to-play launch. Kinship
            Exchange rewards early believers and holds founders accountable to
            ...
            {[
              {
                title: "Fair launch",
                body:
                  "Everyone gets the same seat price. No insider rounds, no whitelists.",
              },
              {
                title: "Transparent",
                body:
              ...
              },
              {
                ...
                body:
                  "Founders earn as members stay. Refunds protect early supporters.",
              },
            ].map((v) => (
              <div key={v.title}>
                <div className="mb-3 flex h-9 w-9 items-center justify-center rounded-md bg-[color:var(--accent-soft)]">
                  <span
        ...
        <section
          id="how-it-works"
          className="mx-auto max-w-6xl px-6 pb-20 pt-20"
        >
            ...
            <div>
              ...
              <ol className="mt-6 space-y-5">
                {[
                  ...
                  {
                    t: "Commit a seat",
                    b: "Seats give you standing: voice in decisions, access to programs, and a share of shared resources.",
                  },
                  {
                    t: "Raise or refund",
                  ...
                  },
                  {
                    ...
                    b: "Decision markets and member councils keep momentum honest. Trade signals, then decide.",
                  },
                ].map((s, i) => (
                  <li key={i} className="flex gap-4">
                    <span className="mt-0.5 flex h-6 w-6 flex-none items-center justify-center rounded-md bg-[color:var(--accent)] text-[11px] font-semibold text-white">
              ...
              <ol className="mt-6 space-y-5">
                {[
                  ...
                  },
                  {
                    ...
                    b: "A seven-day committed window. Pro-rata allocation, time-weighted to reward early conviction.",
                  },
                  {
                    t: "Go live",
                    b: "Hit the goal, unlock the treasury, and start delivering the programs members committed to.",
                  },
                  {
                    t: "Grow with accountability",
                    b: "Monthly updates. Transparent spend. Expansion requires member approval, not insider votes.",
                  },
                ].map((s, i) => (
                  <li key={i} className="flex gap-4">
                    <span className="mt-0.5 flex h-6 w-6 flex-none items-center justify-center rounded-md bg-[color:var(--accent)] text-[11px] font-semibold text-white">
